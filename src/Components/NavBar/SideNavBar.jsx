      ...
      <div className="slider-category-items">
        <div className="menu-slide-out-container">
          <ul id="menu-slidout-1" className="menu">
            ...
            >
              <a href="https://blockworks.co/newsletter/" aria-current="page">
                NEWSLETTER
              </a>
            </li>
            <li
        ...
        <div className="card">
          ...
          <div className="card-content">
            ...
            <div className="card_excerpt">
              <p>
                DAS is the institutionally focused crypto conference for asset
                managers and financial services professionals. Returning in 2021
                as a two day, in person event, industry leaders from the world
                of finance and digital assets will gather to discuss crypto from
                the […]
              </p>
            </div>
      ...
      <div className="slide-footer">
        ...
        <div className="slide-social">
          ...
          <div>
            ...
            <a target="_blank" href="https://www.instagram.com/blockworks__/">
              
            </a>
            <a
              target="_blank"
